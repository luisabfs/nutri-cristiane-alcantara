      ...
      <div className="max-w-6xl mx-auto px-4 relative z-10">
        <div className="flex justify-center md:justify-between items-center py-2 md:py-4 relative">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <button
              onClick={() => {
                const url = 'https://wa.me/5579991175352?text=' + encodeURIComponent('Olá! Gostaria de agendar uma consulta com a nutricionista Cristiane Alcântara.');

                trackEvent({
                  action: 'click_whatsapp',
                  category: 'CTA',
                  label: 'Botão Agendar - Navbar',
                });
